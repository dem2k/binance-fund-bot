...
import com.github.sbouclier.result.TradeBalanceResult;
import com.github.sbouclier.result.TradeVolumeResult;
import com.github.sbouclier.result.TradesHistoryResult;
import com.github.sbouclier.result.TradesInformationResult;
 ...
 */
public class KrakenApiRestClientTest {
    ...
    public void should_return_server_time() throws KrakenApiException, IOException {
        ...
        when(mockClient.callPublic(KrakenApiRestClient.BASE_URL, KrakenApiMethod.SERVER_TIME, ServerTimeResult.class)).thenReturn(mockResult);

        KrakenApiRestClient client = new KrakenApiRestClient(mockClientFactory);
        ...
        verify(mockClient).callPublic(KrakenApiRestClient.BASE_URL, KrakenApiMethod.SERVER_TIME, ServerTimeResult.class);
    }
    ...
    public void should_return_all_asset_information() throws KrakenApiException, IOException {
        ...
        when(mockClient.callPublic(KrakenApiRestClient.BASE_URL, KrakenApiMethod.ASSET_INFORMATION, AssetsInformationResult.class)).thenReturn(mockResult);
        ...
        verify(mockClient).callPublic(KrakenApiRestClient.BASE_URL, KrakenApiMethod.ASSET_INFORMATION, AssetsInformationResult.class);
    }
    ...
    public void should_return_some_asset_information() throws KrakenApiException, IOException {
        ...
        // When
        when(mockClientFactory.getHttpApiClient(KrakenApiMethod.ASSET_INFORMATION)).thenReturn(mockClient);
        when(mockClient.callPublic(KrakenApiRestClient.BASE_URL, KrakenApiMethod.ASSET_INFORMATION, AssetsInformationResult.class, params)).thenReturn(mockResult);
        ...
        verify(mockClientFactory).getHttpApiClient(KrakenApiMethod.ASSET_INFORMATION);
        verify(mockClient).callPublic(KrakenApiRestClient.BASE_URL, KrakenApiMethod.ASSET_INFORMATION, AssetsInformationResult.class, params);
    }
    ...
    public void should_return_all_asset_pairs() throws IOException, KrakenApiException {
        ...
        when(mockClient.callPublic(KrakenApiRestClient.BASE_URL, KrakenApiMethod.ASSET_PAIRS, AssetPairsResult.class)).thenReturn(mockResult);
        ...
        verify(mockClient).callPublic(KrakenApiRestClient.BASE_URL, KrakenApiMethod.ASSET_PAIRS, AssetPairsResult.class);
    }
    ...
    public void should_return_some_asset_pairs() throws IOException, KrakenApiException {
        ...
        // When
        when(mockClientFactory.getHttpApiClient(KrakenApiMethod.ASSET_PAIRS)).thenReturn(mockClient);
        when(mockClient.callPublic(KrakenApiRestClient.BASE_URL, KrakenApiMethod.ASSET_PAIRS, AssetPairsResult.class, params)).thenReturn(mockResult);
        ...
        verify(mockClientFactory).getHttpApiClient(KrakenApiMethod.ASSET_PAIRS);
        verify(mockClient).callPublic(KrakenApiRestClient.BASE_URL, KrakenApiMethod.ASSET_PAIRS, AssetPairsResult.class, params);
    }
    ...
    public void should_return_ticker_information() throws IOException, KrakenApiException {
        ...
        when(mockClient.callPublic(KrakenApiRestClient.BASE_URL, KrakenApiMethod.TICKER_INFORMATION, TickerInformationResult.class, params)).thenReturn(mockResult);
        ...
        verify(mockClient).callPublic(KrakenApiRestClient.BASE_URL, KrakenApiMethod.TICKER_INFORMATION, TickerInformationResult.class, params);
    }
    ...
    public void should_return_ohlc() throws IOException, KrakenApiException {
        ...
        when(mockClient.callPublicWithLastId(KrakenApiRestClient.BASE_URL, KrakenApiMethod.OHLC, OHLCResult.class, params)).thenReturn(mockResult);
        ...
        verify(mockClient).callPublicWithLastId(KrakenApiRestClient.BASE_URL, KrakenApiMethod.OHLC, OHLCResult.class, params);
    }
    ...
    public void should_return_order_book() throws IOException, KrakenApiException {
        ...
        when(mockClient.callPublic(KrakenApiRestClient.BASE_URL, KrakenApiMethod.ORDER_BOOK, OrderBookResult.class, params)).thenReturn(mockResult);
        ...
        verify(mockClient).callPublic(KrakenApiRestClient.BASE_URL, KrakenApiMethod.ORDER_BOOK, OrderBookResult.class, params);
    }
    ...
    public void should_return_recent_trades() throws IOException, KrakenApiException {
        ...
        when(mockClient.callPublicWithLastId(KrakenApiRestClient.BASE_URL, KrakenApiMethod.RECENT_TRADES, RecentTradeResult.class, params)).thenReturn(mockResult);
        ...
        verify(mockClient).callPublicWithLastId(KrakenApiRestClient.BASE_URL, KrakenApiMethod.RECENT_TRADES, RecentTradeResult.class, params);
    }
    ...
    public void should_return_recent_spread() throws IOException, KrakenApiException {
        ...
        when(mockClient.callPublicWithLastId(KrakenApiRestClient.BASE_URL, KrakenApiMethod.RECENT_SPREADS, RecentSpreadResult.class, params)).thenReturn(mockResult);
        ...
        verify(mockClient).callPublicWithLastId(KrakenApiRestClient.BASE_URL, KrakenApiMethod.RECENT_SPREADS, RecentSpreadResult.class, params);
    }
    ...
    public void should_return_account_balance() throws IOException, KrakenApiException {
        ...
        when(mockClient.callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.ACCOUNT_BALANCE, AccountBalanceResult.class)).thenReturn(mockResult);

        KrakenApiRestClient client = new KrakenApiRestClient("apiKey", "apiSecret", mockClientFactory);
        ...
        verify(mockClient).callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.ACCOUNT_BALANCE, AccountBalanceResult.class);
    }
    ...
    public void should_return_trade_balance() throws IOException, KrakenApiException {
        ...
        when(mockClient.callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.TRADE_BALANCE, TradeBalanceResult.class)).thenReturn(mockResult);
        ...
        verify(mockClient).callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.TRADE_BALANCE, TradeBalanceResult.class);
    }
    ...
    public void should_return_open_orders() throws IOException, KrakenApiException {
        ...
        when(mockClient.callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.OPEN_ORDERS, OpenOrdersResult.class)).thenReturn(mockResult);

        KrakenApiRestClient client = new KrakenApiRestClient("apiKey", "apiSecret", mockClientFactory);
        OpenOrdersResult result = client.getOpenOrders();

        assertThat(result.getResult().open.size(), equalTo(2));
        assertThat(result.getResult().open.get("O6OWRK-D3FA3-WT2UL4").description.price, Matchers.comparesEqualTo(BigDecimal.valueOf(0.101122)));
        assertThat(result.getResult().open.get("O6OWRK-D3FA3-WT2UL5").description.price, Matchers.comparesEqualTo(BigDecimal.valueOf(0.101133)));

        verify(mockClientFactory).getHttpApiClient("apiKey", "apiSecret", KrakenApiMethod.OPEN_ORDERS);
        verify(mockClient).callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.OPEN_ORDERS, OpenOrdersResult.class);
    }
    ...
    public void should_return_closed_orders() throws IOException, KrakenApiException {
        ...
        when(mockClient.callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.CLOSED_ORDERS, ClosedOrdersResult.class)).thenReturn(mockResult);

        KrakenApiRestClient client = new KrakenApiRestClient("apiKey", "apiSecret", mockClientFactory);
        ClosedOrdersResult result = client.getClosedOrders();

        assertThat(result.getResult().closed.size(), equalTo(2));
        assertThat(result.getResult().closed.get("OQR6ZR-EGNQD-GV4TKZ").description.price, Matchers.comparesEqualTo(BigDecimal.valueOf(11949)));
        assertThat(result.getResult().closed.get("OTJDWA-YMV5L-DTIUTI").description.price, Matchers.comparesEqualTo(BigDecimal.valueOf(119596)));

        verify(mockClientFactory).getHttpApiClient("apiKey", "apiSecret", KrakenApiMethod.CLOSED_ORDERS);
        verify(mockClient).callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.CLOSED_ORDERS, ClosedOrdersResult.class);
    }
    ...
    public void should_return_orders_information() throws IOException, KrakenApiException {
        ...
        when(mockClient.callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.ORDERS_INFORMATION, OrdersInformationResult.class, params)).thenReturn(mockResult);
        ...
        verify(mockClient).callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.ORDERS_INFORMATION, OrdersInformationResult.class, params);
    }
    ...
    public void should_return_trades_history() throws IOException, KrakenApiException {
        ...
        when(mockClient.callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.TRADES_HISTORY, TradesHistoryResult.class)).thenReturn(mockResult);
        ...
        verify(mockClient).callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.TRADES_HISTORY, TradesHistoryResult.class);
    }
    ...
    public void should_return_trades_information() throws IOException, KrakenApiException {
        ...
        when(mockClient.callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.TRADES_INFORMATION, TradesInformationResult.class, params)).thenReturn(mockResult);
        ...
        verify(mockClient).callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.TRADES_INFORMATION, TradesInformationResult.class, params);
    }
    ...
    public void should_return_open_positions() throws IOException, KrakenApiException {
        ...
        when(mockClient.callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.OPEN_POSITIONS, OpenPositionsResult.class, params)).thenReturn(mockResult);
        ...
        verify(mockClient).callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.OPEN_POSITIONS, OpenPositionsResult.class, params);
    }
    ...
    public void should_return_ledgers_information() throws IOException, KrakenApiException {
        ...
        when(mockClient.callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.LEDGERS_INFORMATION, LedgersInformationResult.class)).thenReturn(mockResult);
        ...
        verify(mockClient).callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.LEDGERS_INFORMATION, LedgersInformationResult.class);
    }
    ...
    public void should_return_ledgers() throws IOException, KrakenApiException {
        ...
        when(mockClient.callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.QUERY_LEDGERS, LedgersResult.class, params)).thenReturn(mockResult);
        ...
        verify(mockClient).callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.QUERY_LEDGERS, LedgersResult.class, params);
    }
    ...
    public void should_return_trade_volume() throws IOException, KrakenApiException {
        ...
        when(mockClient.callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.TRADE_VOLUME, TradeVolumeResult.class)).thenReturn(mockResult);
        ...
        verify(mockClient).callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.TRADE_VOLUME, TradeVolumeResult.class);
    }

    @Test
    public void should_return_withdraw_reference() throws IOException, KrakenApiException {
        ...
        Map<String, String> params = new HashMap<>();
        params.put("asset", "XLM");
        params.put("key", "binance");
        params.put("amount", "100.1");

        // When
        when(mockClientFactory.getHttpApiClient("apiKey", "apiSecret", KrakenApiMethod.WITHDRAW)).thenReturn(mockClient);
        when(mockClient.callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.WITHDRAW, WithdrawResult.class, params)).thenReturn(mockResult);

        KrakenApiRestClient client = new KrakenApiRestClient("apiKey", "apiSecret", mockClientFactory);
        WithdrawResult result = client.withdraw("XLM", "binance", "100.1");

        assertThat(result.getResult().referenceId, equalTo("AAAAAA-BBBBBB-CCCCCC"));

        verify(mockClientFactory).getHttpApiClient("apiKey", "apiSecret", KrakenApiMethod.WITHDRAW);
        verify(mockClient).callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.WITHDRAW, WithdrawResult.class, params);
    }

    @Test
    public void should_return_add_order_reference() throws IOException, KrakenApiException {
        final String jsonResult = StreamUtils.getResourceAsString(this.getClass(), "json/add_order.mock.json");
        AddOrderResult mockResult = new ObjectMapper().readValue(jsonResult, AddOrderResult.class);

        BigDecimal amount = new BigDecimal("2.1234");
        String ticker = "XBTUSD";
        BigDecimal price = new BigDecimal("45000.11");
        ...
        params.put("pair", ticker);
        params.put("price", price.toString());

        // When
        when(mockClientFactory.getHttpApiClient("apiKey", "apiSecret", KrakenApiMethod.ADD_ORDER)).thenReturn(mockClient);
        when(mockClient.callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.ADD_ORDER, AddOrderResult.class, params)).thenReturn(mockResult);

        KrakenApiRestClient client = new KrakenApiRestClient("apiKey", "apiSecret", mockClientFactory);
        AddOrderResult result = client.addLimitOrder(direction, ticker, amount, price,null);

        assertThat(result.getResult().txid.get(0), equalTo("OUF4EM-FRGI2-MQMWZD"));

        verify(mockClientFactory).getHttpApiClient("apiKey", "apiSecret", KrakenApiMethod.ADD_ORDER);
        verify(mockClient).callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.ADD_ORDER, AddOrderResult.class, params);
