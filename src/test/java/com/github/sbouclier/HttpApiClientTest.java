...
public class HttpApiClientTest {
    ...
    public void should_call_valid_public_method() throws IOException, KrakenApiException {
        ...
        when(mockHttpJsonClient.executePublicQuery(
                eq(KrakenApiRestClient.BASE_URL),
                eq(KrakenApiMethod.SERVER_TIME.getUrl(0)))
        ).thenReturn(mockResponseBody);

        // When
        ServerTimeResult result = client.callPublic(KrakenApiRestClient.BASE_URL, KrakenApiMethod.SERVER_TIME, ServerTimeResult.class);
        ...
        verify(mockHttpJsonClient).executePublicQuery(eq(KrakenApiRestClient.BASE_URL), eq(KrakenApiMethod.SERVER_TIME.getUrl(0)));
    }
    ...
    public void should_call_invalid_public_method_with_error() throws IOException, KrakenApiException {
        ...
        // When
        try {
            client.callPublic(KrakenApiRestClient.BASE_URL, KrakenApiMethod.SERVER_TIME, ServerTimeResult.class);
    ...
    public void should_call_invalid_public_method_with_params_and_error() throws IOException, KrakenApiException {
        ...
        // When
        try {
            client.callPublic(KrakenApiRestClient.BASE_URL, KrakenApiMethod.TICKER_INFORMATION, TickerInformationResult.class, params);
    ...
    public void should_call_invalid_public_method_with_unextractable_last_id() throws IOException, KrakenApiException {
        ...
        // When
        try {
            client.callPublicWithLastId(KrakenApiRestClient.BASE_URL, KrakenApiMethod.OHLC, OHLCResult.class, params);
    ...
    public void should_call_valid_private_method() throws IOException, KrakenApiException {
        ...
        // When
        AccountBalanceResult result = client.callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.ACCOUNT_BALANCE, AccountBalanceResult.class);
        ...
        verify(mockHttpJsonClient).executePrivateQuery(eq(KrakenApiRestClient.BASE_URL), eq(KrakenApiMethod.ACCOUNT_BALANCE.getUrl(0)));
    }
    ...
    public void should_call_invalid_private_method_with_error() throws IOException, KrakenApiException {
        ...
        // When
        try {
            client.callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.ACCOUNT_BALANCE, AccountBalanceResult.class);
    ...
    public void should_call_invalid_private_method_with_params_and_error() throws IOException, KrakenApiException {
        ...
        // When
        try {
            client.callPrivate(KrakenApiRestClient.BASE_URL, KrakenApiMethod.ORDERS_INFORMATION, OrdersInformationResult.class, params);
